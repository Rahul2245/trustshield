...
export const UserProfilePage: React.FC = () => {
  const { user: authUser, hydrate, logout } = useAuthStore();
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-20 px-8 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
           ...
           <button 
             ...
             className="px-4 py-2 bg-red-50 text-red-600 border border-red-200 rounded-full text-sm font-semibold hover:bg-red-100 transition-all shadow-sm hover:shadow active:scale-95"
           >
             Logout
           </button>
        </div>
